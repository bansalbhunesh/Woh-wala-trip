...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_creator_created_at
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_creator_lore_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_processing_started_at
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_public_showcase
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_creator_lore_ready
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_photos_trip_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_photos_trip_embedding_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_photos_embedding_pending
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trip_members_trip_user
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trip_members_user_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_otp_codes_email
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_lore_reactions_trip_id
  ON public.lore_reactions(trip_id);

-- ── trip_vs_trip (battles) table ─────────────────────────────────────────────

-- Battle lookup by member's trip IDs
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trip_vs_trip_trip_a_id
  ON public.trip_vs_trip(trip_a_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trip_vs_trip_trip_b_id
  ON public.trip_vs_trip(trip_b_id);

-- Recent battles rate-limiting check
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trip_vs_trip_created_at
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_scheduled_emails_send_at
