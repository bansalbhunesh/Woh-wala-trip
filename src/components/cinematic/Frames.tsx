...
export function Scene({
  ...
  return (
    <motion.section
      ...
      className={cn(
        'relative min-h-[80vh] flex flex-col justify-center px-6 py-20 overflow-hidden',
        className
      )}
    >
      {children}
    ...
    >
      ...
      <div className="relative w-full md:w-1/2 aspect-[4/5] rounded-[2rem] overflow-hidden group">
        <div
          ...
          style={{
            backgroundImage: `url(${image || 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957'})`,
        ...
        <div className="absolute top-8 left-8">
          {badge && (
            <div className="px-4 py-1.5 rounded-full bg-white text-black text-[9px] font-black uppercase tracking-widest">
              {badge}
            </div>
          )}
        </div>
