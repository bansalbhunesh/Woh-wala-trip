    ...
    >
      ...
      <main className="mx-auto max-w-2xl px-6 py-16 pb-32">
        ...
        <div className="mb-14 space-y-3">
          ...
          >
            Terms of<br />
            <em className="italic" style={{ color: '#FF4D4D' }}>Service</em>
          </h1>
          <p
        ...
        <div className="space-y-12 font-data">
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              ...
              that you meet this requirement. If you are under 18, you confirm you have your
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              You may not create accounts on behalf of others without their consent, or use
              another person&apos;s email address to create an account.
            </p>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              You retain full ownership of the photos and data you upload (&quot;Your Content&quot;).
              By uploading content, you grant us a limited, non-exclusive, royalty-free licence
              to store, transmit, and process Your Content solely to provide the service — including
              sending photos to our AI provider (Anthropic) for lore generation.
            </p>
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              This licence ends when you delete the content or close your account.
              We will not use Your Content for advertising, share it publicly, or sell it.
            </p>
            <div
            ...
            >
              ...
              <ul className="space-y-2" style={{ color: 'rgba(245,240,232,0.6)', fontSize: '0.875rem', lineHeight: 1.7 }}>
                <li>— Is owned by you, or you have permission from all people depicted to upload it</li>
                <li>— Does not contain illegal material (CSAM, non-consensual intimate imagery, etc.)</li>
                <li>— Does not infringe anyone else&apos;s copyright or privacy rights</li>
                <li>— Does not depict graphic violence or content intended to harass individuals</li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              ...
              text (&quot;friendship lore&quot;). AI-generated content is provided for entertainment and
              personal memory purposes only.
            </p>
          ...
          <section className="space-y-5">
            ...
            <ul className="space-y-3" style={{ color: 'rgba(245,240,232,0.6)', fontSize: '0.875rem', lineHeight: 1.7 }}>
              {[
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              ...
              before any charge is applied. No payment details are collected through the app
              at this time.
            </p>
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              We reserve the right to modify, limit, or discontinue any free features at any
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              The app is provided <span style={{ color: 'rgba(245,240,232,0.8)' }}>&quot;as is&quot;</span> and{' '}
              <span style={{ color: 'rgba(245,240,232,0.8)' }}>&quot;as available&quot;</span> without any
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              AI-generated content may be inaccurate, incomplete, or unintentionally offensive.
              We are not liable for any reliance placed on AI outputs. The service depends on
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              ...
              the app, including loss of data, loss of profits, or damage arising from reliance
              on AI-generated content.
            </p>
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              Our total aggregate liability for any claim arising out of these Terms or your use
              of the service shall not exceed ₹1,000 (Indian Rupees one thousand) or the amount
              you paid us in the previous 12 months, whichever is greater.
            </p>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              All app design, branding, code, and non-user-generated content is owned by Woh
              Wala Trip or its licensors. You may not copy, reproduce, or create derivative works
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              ...
              courts located in India. We encourage resolving disputes amicably — please contact
              us before initiating any formal proceeding.
            </p>
          </section>
          ...
          <section className="space-y-5">
            ...
            <p style={{ color: 'rgba(245,240,232,0.65)', lineHeight: 1.75, fontSize: '0.9375rem' }}>
              We may update these Terms as the app grows. Material changes will be communicated
              via the &quot;Last updated&quot; date at the top of this page and, where practical, via email.
